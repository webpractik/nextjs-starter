...
export function SelectTrigger({
    ...
    return (
        <SelectPrimitive.Trigger data-slot="select-trigger" data-size={size} className={cn(`
            ...
            bg-transparent py-2 pr-2 pl-2.5 text-sm whitespace-nowrap shadow-xs
        ...
        `, className)} {...props}>
            {children}
            <SelectPrimitive.Icon render={<ChevronDownIcon className={`
        ...
        <SelectPrimitive.Portal>
            ...
            >
                <SelectPrimitive.Popup data-slot="select-content" className={cn(`
                    ...
                    origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-md
