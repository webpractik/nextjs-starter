...
export type Field =
    | {
          ...
          key: string
          /**
           * Field mapped name. This is the name we want to use in the request. If omitted, we use
    ...
    | {
          ...
          key: string
          /**
           * Field mapped name. This is the name we want to use in the request. If `in` is omitted,
           * `map` aliases `key` to the transport layer.
           */
          map: Slot
      }
