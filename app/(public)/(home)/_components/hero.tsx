...
export function Hero() {
    return (
        <div className="transition-bg relative flex size-full h-[100vh] flex-col items-center justify-center bg-radial from-black to-black/95 text-slate-950">
            <motion.div
            ...
            >
                <Typography
                    className="bg-opacity/50 bg-linear-to-b from-neutral-50 to-neutral-400 bg-clip-text text-center text-4xl font-bold text-transparent md:text-7xl"
                    variant="h1"
                >
                    Next Starter
                </Typography>
